      ...
      <div class="col-lg-5 col-md-6 mt-4 mb-4 ml-5">
        <div class="card z-index-2 ">
          ...
          <div class="card-body">
            ...
            <a href="{{url('PendingUsers')}}"style="margin-left:20%;margin-bottom:9%"><button class="btn btn-dark" >Show Users </button></a>
            </div>
          </div>
        </div>
      </div>
     <div class="col-lg-5 col-md-6 mt-4 mb-4 ml-5">
        <div class="card z-index-2 ">
          ...
          <div class="card-body">
            ...
            <hr class="dark horizontal">
            <div class="d-flex ml-5" >
              <a href="{{url('PendingRequests')}}"style="margin-left:20% ; "><button class="btn btn-dark" >Show Requests </button>
            </div>
          </div>
        </div>
      </div>
